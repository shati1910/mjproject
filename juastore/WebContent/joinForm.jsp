		...
		<table>
			...
			<tr>
			 ...
			 <tr>
				...
				<input type="text" name="exaddr" id="exaddr" placeholder="참고항목" size="10" readonly></td>
			 </tr>
...
① /주아스토어(‘http://localhost:8088/juastore’이하 ‘juastore’) 은(는) 정보주체로부터 개인정보를 수집할 때 동의 받은 개인정보 보유․이용기간 또는 법령에 따른 개인정보 보유․이용기간 내에서 개인정보를 처리․보유합니다.
...
① 정보주체는 /주아스토어(‘http://localhost:8088/juastore’이하 'juastore') 에 대해 언제든지 다음 각 호의 개인정보 보호 관련 권리를 행사할 수 있습니다.
1. 개인정보 열람요구
2. 오류 등이 있을 경우 정정 요구
3. 삭제요구
4. 처리정지 요구
...
제2조(정의)
  ...
  ① “몰”이란 주아스토어 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
  ...
  ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
			...
			<tr>
				...
				<div class="tableButton">
					<input type="submit" value="동의하고 가입" onclick="chkForm(this.form)">
